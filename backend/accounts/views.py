...
from .utils import makeCompany, google_get_access_token, google_validate_id_token, google_get_user_info
from .models import CustomUser, Company, InviteToken
from .serializers import UserSerializer, UserSerializerWithToken, UserListSerializer, MyTokenObtainPairSerializer, InputSerializer
...
class GoogleLoginApi(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # THIS IS NOT CORRECT FOR OUR CASE
        ...
        user, _ = CustomUser.objects.get(**profile_data)
