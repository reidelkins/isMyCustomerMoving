...
urlpatterns = [
    ...
    path('downloadrecentlysold/<str:company>/', views.AllRecentlySoldView.as_view(), name='all-recently-sold'),
    ...
    path('downloadclients/<str:user>/', views.DownloadClientView.as_view(), name='all-client-list'),
