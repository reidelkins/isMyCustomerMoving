        ...
        {userInfo.company.enterprise || userInfo.email === 'reid@gmail.com' || userInfo.email === 'reid@ismycustomermoving.com' || userInfo.email === 'jb@aquaclearws.com' ? (
          <>
            ...
            <Stack direction="row" spacing={2}>
              <Button sx={incoming ? selectedButton : notSelectedButton} variant="contained" onClick={handleIncoming}>
                Incoming
              </Button>
              <Button sx={!incoming ? selectedButton : notSelectedButton} variant="contained" onClick={handleOutgoing}>
                Outgoing
              </Button>
            </Stack>
          </>
          ...
          <Box className="bg-gray-100 p-8 rounded-md shadow-md" sx={{ maxWidth: 500, margin: '0 auto' }}>
            <Typography variant="h4" component="h1" gutterBottom>
              Access Restricted
            </Typography>
            <Typography variant="body1" gutterBottom>
              We're sorry, but it appears that you do not have access to this page. This page is reserved for companies
              who belong to a franchise that have an account.
            </Typography>
            <Typography variant="body1" gutterBottom>
              If you are interested in the benefits of being part of a franchise within Is My Customer Moving, contact
              us!
            </Typography>
          </Box>
        )}
