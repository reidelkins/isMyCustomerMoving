    ...
    <div>
        ...
        <Dialog open={open} onClose={handleClose} sx={{padding:"2px"}}>
            ...
            <div style={{ padding: '20px', fontSize: '1.2rem' }}>
                ...
                <Typography  variant="h5" color="primary" marginTop={3}>Scan QR Code</Typography>
                <Divider />
                <div >
                    <img
                ...
                <div>
                <Typography  variant="h6" color="primary" marginTop={3}>Or Enter Code Into Your App</Typography>
                <Divider />
                <p >SecretKey: {userInfo.otp_base32} (Base32 encoded)</p>
                </div>
                <div>
                <Typography  variant="h6" color="primary" marginTop={3}>Verify Code</Typography>
                <Divider />
                <p >
