    ...
    <div>
      ...
      <Dialog open={open} onClose={handleClose} sx={{ padding: '2px' }}>
        ...
        <DialogContent>
          <Stack spacing={3}>
            <Typography>
              If this client's home has been incorrectly marked as for sale/recently sold, press confirm below.
            </Typography>
            <Typography>
              Letting us know this fixes the status of the customer in your dashboard, removes any Is My Customer Moving
              tags for the customer in your CRM, and allows us to investigate the issue in order to get better for you!{' '}
            </Typography>
          </Stack>
